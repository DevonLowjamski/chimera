...
namespace ProjectChimera.Core
{
    ...
    public class RuntimeSystemTester : ChimeraMonoBehaviour
    {
        ...
        private IEnumerator TestSaveManager()
        {
            ...
            var testComponent = gameObject.AddComponent<RuntimeTestSaveableComponent>();
    ...
    /// Runtime-compatible version.
    /// </summary>
    public class RuntimeTestSaveableComponent : MonoBehaviour, ISaveable
    {
        private RuntimeTestSaveData _testData = new RuntimeTestSaveData { TestValue = 42, TestString = "Test" };

        public string GetSaveId()
        {
            return "RuntimeTestSaveableComponent_" + GetInstanceID();
        }
        ...
        {
            if (data is RuntimeTestSaveData testData)
            {
                _testData = testData;
            }
        }
        ...
        [System.Serializable]
        public class RuntimeTestSaveData
        {
